...
namespace OOP_2
{
    class TennisGame:Game
    {
        ...
        public override string getResult(int player_score1,int player_score2)
        {
        ...
        public override string getSame(int players_score)
        {
        ...
        public override string actualScore(int player_score1,int player_score2)
        {
            result = "";
            int tempScore;
            for (var i = 1; i < 3; i++)
